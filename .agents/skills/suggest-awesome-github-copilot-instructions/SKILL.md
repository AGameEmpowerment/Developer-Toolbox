...
12. **Download/Update Assets**: For requested instructions, automatically:
    - Download new instructions to `.ai/instructions/` folder
...
- Scan local file system for existing instructions in `.ai/instructions/` directory
...
5. Preserve file location in `.ai/instructions/` directory
