...
- Reference specific instruction files for detailed standards:
  - Language guidelines: `.ai/instructions/{language}.md`
  - Testing: `.ai/instructions/testing.md`
  - Security: `.ai/instructions/security.md`
  - Documentation: `.ai/instructions/documentation.md`
  - Performance: `.ai/instructions/performance.md`
  - Code review: `.ai/instructions/code-review.md`
```

### 2. `.ai/instructions/` Directory
