...
- `.ai/instructions/security-and-owasp.md` (security baseline)
- `.ai/instructions/performance-optimization.md`
- `.ai/instructions/a11y.md`
- `.ai/instructions/devops-core-principles.md` (CALMS + DORA)
- `.ai/instructions/self-explanatory-code-commenting.md` (minimal WHY‑focused commentary)
