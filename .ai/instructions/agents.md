...
- Location: `.ai/agents/` directory (repository-level) or `agents/` directory (organization/enterprise-level)
...
Spec: .ai/agents/data-processor.agent.md
...
Agent: data-analyst
Spec: .ai/agents/data-analyst.agent.md
Context: projectName=${projectName}, basePath=${basePath}
...
```text
This phase must be performed as the agent "documentation-writer" defined in ".ai/agents/documentation-writer.agent.md".
...
Spec: .ai/agents/security-reviewer.agent.md
...
Agent: test-coverage
Spec: .ai/agents/test-coverage.agent.md
Context: repositoryName=${repositoryName}, prNumber=${prNumber}, basePath=projects/${repositoryName}/pr-${prNumber}
Output: projects/${repositoryName}/pr-${prNumber}/coverage-report.md

Step 3: Aggregate
Agent: review-aggregator
Spec: .ai/agents/review-aggregator.agent.md
Context: repositoryName=${repositoryName}, prNumber=${prNumber}, basePath=projects/${repositoryName}/pr-${prNumber}
...
```text
This phase must be performed as the agent "security-reviewer" defined in ".ai/agents/security-reviewer.agent.md".
...
- [ ] File placed in correct directory (`.ai/agents/` or `agents/`)
...
- [AI Asset Curator](../../.agents/skills/ai-asset-curator/SKILL.md) - For creating canonical instruction files and generated adapters
