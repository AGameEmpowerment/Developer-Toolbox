...
echo -e "${GRAY}  Azurite Blob:   localhost:${AZURITE_BLOB_PORT:-10000}${NC}"
echo -e "${GRAY}  Azurite Queue:  localhost:${AZURITE_QUEUE_PORT:-10001}${NC}"
echo -e "${GRAY}  Azurite Table:  localhost:${AZURITE_TABLE_PORT:-10002}${NC}"
