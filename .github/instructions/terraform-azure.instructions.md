...
For general Terraform conventions, see [terraform.md](terraform.md).

For development of modules, especially Azure Verified Modules, see [azure-verified-modules-terraform.md](azure-verified-modules-terraform.md).
...
Any significant resource should use an AVM if available. AVMs are designed to be aligned to the Well Architected Framework, are supported and maintained by Microsoft helping reduce the amount of code to be maintained. Information about how to discover these is available in [Azure Verified Modules for Terraform](azure-verified-modules-terraform.md).
