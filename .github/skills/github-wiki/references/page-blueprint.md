...
| Page file | Purpose |
|---|---|
| `AI-Assisted-Development.md` or `Agent-and-Copilot-Guidance.md` | Instruction precedence (`AGENTS.md`, `CLAUDE.md`, `.github/`), canonical versus generated adapters, how to sync them, and repository and data boundaries agents must respect. |
